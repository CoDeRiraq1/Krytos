...
HELP_3 = """  \n   جميع اوامر ومميزات MIXTHON \n✨
 همسة قم بكتابة معرف البوت مع معرف الشخص لأرسال همسة او همسة لمرة واحدة ⭐\n<تحميل من بنترست  ارسل الأمر بنترست <اسم الصورة \n \n الأمر  `/qr ` سيقوم بصنع كاشف خاص بك  \n ~  @mixthon ❤️‍🔥 لاتنسى متابعة قناة التحديثات ."""
