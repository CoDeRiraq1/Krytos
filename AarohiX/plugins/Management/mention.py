...
array = []
@app.on_message(command(["@all", "all","تاك"]) & ~filters.private)
async def nummmm(client: app, message):
  ...
  if message.photo:
          ...
          zz = message.caption
  try:
   zz = zz.replace("@all","نداء").replace("تاك للكل","").replace("حاجيهم","")
  except:
    pass
...
@app.on_message(command(["وكف المنشن", "/cancel","ايقاف منشن"]))
