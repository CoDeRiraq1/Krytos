...
TAGMES = [ " **𝐇𝐞𝐲 𝐁𝐚𝐛𝐲 𝐊𝐚𝐡𝐚 𝐇𝐨🥱** ",
           ...
           " **𝐇𝐞𝐦𝐥𝐨𝐨🧐** ",
           " **𝐌𝐮𝐣𝐡𝐞 𝐁𝐡𝐮𝐥 𝐆𝐲𝐞 𝐊𝐲𝐚🥺** ",
           " **𝐘𝐚𝐡𝐚 𝐀𝐚 𝐉𝐚𝐨:- [ @V_64_V] 𝐌𝐚𝐬𝐭𝐢 𝐊𝐚𝐫𝐞𝐧𝐠𝐞 🤭🤭** ",
...
@app.on_message(filters.command(["تاك للكل", "all", "تاك"], prefixes=["/", "@", "#", ""]))
async def mentionall(client, message):
    ...
    try:
        ...
        if participant.status in (
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("الأمر للمشرفين فقط ! . ")
    ...
    if message.reply_to_message and message.text:
        ...
        if not msg:
            return await message.reply("تاك للكل 👈 Try this or reply any message ...")
    else:
        return await message.reply("تاك للكل 👈 Try this or reply any message ..")
...
@app.on_message(filters.command(["cancel", "ايقاف"]))
